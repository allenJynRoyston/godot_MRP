...
# ---------------------a
func cancel_construction(from_location:Dictionary) -> bool:
...
func reset_room(from_location:Dictionary) -> bool:
	...
	var room_extract:Dictionary = GAME_UTIL.extract_room_details(from_location)
