...
var filter_for_type:RESEARCHER.SPECIALIZATION = RESEARCHER.SPECIALIZATION.ADMIN
...
func start(_assigned_uids:Array = [], _filter_for_type:int = RESEARCHER.SPECIALIZATION.RESEARCHER, _use_location:Dictionary = {}) -> void:
