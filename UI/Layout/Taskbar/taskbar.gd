...
@onready var Logo:HBoxContainer = $MarginContainer/HBoxContainer/LeftContainer/Logo
...
@onready var MidContainer:HBoxContainer = $MarginContainer/HBoxContainer/MidContainer
