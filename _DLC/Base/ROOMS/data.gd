...
var ADMIN_LINK_1:Dictionary = ADMIN.get_room_data(ROOM.REF.ADMIN_LINK_1)

var ADMIN_LINK_2:Dictionary = ADMIN.get_room_data(ROOM.REF.ADMIN_LINK_2)

var ADMIN_LINK_3:Dictionary = ADMIN.get_room_data(ROOM.REF.ADMIN_LINK_3)

var ADMIN_LINK_4:Dictionary = ADMIN.get_room_data(ROOM.REF.ADMIN_LINK_4)

var ADMIN_LINK_5:Dictionary = ADMIN.get_room_data(ROOM.REF.ADMIN_LINK_5)
#endregion
